...
public class MovingRotorTest {
    ...
    public void checkAtNotch() {
        setRotor("I", NAVALA, "MCU");
        rotor.set(2);
        assertTrue("Rotor is at notch", rotor.atNotch());
        rotor.advance();
        assertFalse("After advancing, the rotor is not at notch",
                rotor.atNotch());
    }

    @Test
    public void generalTest1() {
        setRotor("III", NAVALA, "MCU");
        rotor.set(25);
        rotor.advance();
    ...
    public void generalTest3() {
        setRotor("IV", NAVALB, "MXQ");
        checkRotor("Rotor IV", UPPER_STRING, NAVALB_MAP.get("IV"));
    }

    @Test
    public void generalTest4() {
        setRotor("V", NAVALZ, "MB");
        rotor.advance();
