...
public class IntListTest {
    ...
    public void testSquareListRecursive() {
        ...
        IntList L2_squared = IntList.squareListRecursive(L2);

        // TODO: remove placeholder
        /* check for correctness */
        assertEquals(L2_squared, IntList.list(1,9,25,49));

        /* check for non-destructiveness */
        assertEquals(L2, IntList.list(1,3,5,7));
